      ...
      <div data-aos="fade-up" className="project-body mt-3">
        <div className="project-card">
          ...
          <div className="project-details">
            ...
            <ul
              data-aos="slide-down"
              className="list-inline-mb-0 tech-tools align-left"
            >
              {tools.map((tl) => (
                <li className="list-inline-item tools">{tl.item}</li>
              ))}
            </ul>
          </div>
        </div>
        <div className="project-content">
          ...
          <div className="links ml-4 pb-3">
            <a target="_blank" href={live} className="live-link">
              Website
            </a>
            <a target="_blank" href={git} className="git-link">
              GitHub
            </a>
          </div>
        </div>
